...
public class AddressController {
    ...
    public ResultVo addAddress(HttpServletRequest request, @RequestBody Address address) {
       int i= addressService.addAddress(address);
       if(i>0){
           return new ResultVo(Message.Success,address);
       }
    ...
    public ResultVo getAllAddressByUserId(HttpServletRequest request, @RequestParam(value = "userId") Long userId) {
        List<Address> addressList= addressService.selectAllByUserId(userId);
        if(addressList!=null){
            return new ResultVo(Message.Success,addressList);
        }
        return new ResultVo(Message.NoResult);
    }
    ...
    public ResultVo updateAddressById(HttpServletRequest request, @RequestParam(value = "id") int id, @RequestBody Address address) {
        address.setId(id);
    ...
    public ResultVo deleteAddressById(HttpServletRequest request, @RequestParam(value = "id") int id) {
