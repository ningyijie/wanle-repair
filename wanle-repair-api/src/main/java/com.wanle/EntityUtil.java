...
public class EntityUtil {
    ...
    private final String moduleName = "PhoneRepair"; // 数据库名称
    ...
    private final String dao_package = "com.wanle.dao";// dao的包所在
...
//            }
    ...
    private void buildMapper(List<String> columns, List<String> types) throws IOException {
        ...
        bw.newLine();
        bw.write("import com.wanle.utils.CommonQueryBean;");
        bw.newLine();
        bw.newLine();
