package com.wanle.constant;

import java.util.HashMap;
import java.util.Map;

/**
 * class_name: WxMessageConstant
 * package: com.wanle.constant
 * describe: TODO 微信公众号 API code 码表
...
public class WxMessageConstant {
    ...
    public static final Map<String,String> wxMessageCode =  new HashMap<String,String>(){
        {
            put("-1","系统繁忙");
            put("0","请求成功");
